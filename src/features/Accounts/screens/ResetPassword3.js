...
import { styles } from "../components/ResetPassword3Styles";
      ...
      <View style={styles.pannel1}>
        ...
        <View style={styles.passwordinputfield}>
          <TextInput
            style={
              isFocused.entry1
                ? [styles.textinput, { borderColor: "#438EFF" }]
                : styles.textinput
            }
            value={password}
          ...
          <TouchableOpacity
            ...
            <Icon
              name={passoption1 === false ? "eye" : "eye-off-outline"}
              size={20}
              color={"#7A7A7A"}
            />
          </TouchableOpacity>
          ...
          <TouchableOpacity
            ...
            <Icon
              name={passoption2 === false ? "eye" : "eye-off-outline"}
              size={20}
              color={"#7A7A7A"}
            />
          </TouchableOpacity>
        ...
        <TouchableOpacity
          ...
          onPress={() => {
            if (password === "" || subpass === "") {
              Alert.alert(
                "Failed",
                "Please enter your new password first before to proceed.",
              ...
              Alert.alert(
                "Failed",
                "You entered your old password, make sure to enter new password.",
                [{ text: "again", onPress: () => console.log("closed") }]
              );
            } else if (password !== subpass && subpass !== password) {
              Alert.alert(
                "Password Mismatch",
                "The password you entered did not match. make sure both the same.",
                [{ text: "again", onPress: () => console.log("closed") }]
              );
            }
          }}>
