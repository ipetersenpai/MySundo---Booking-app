...
import { styles } from "./UserInformationStyles";
...
export default function UserInformation() {
  ...
  // let userEmail_password = useRoute(route).params;
    ...
    <SafeAreaView style={styles.containter}>
      ...
      <View style={styles.pannel1}>
        ...
        <View style={styles.container3}>
          <TextInput
            style={styles.bdayandgenderinputstyle}
            placeholder="Gender"
            onChangeText={(text) => {
              !text ? Setminiplaceholder7("") : Setminiplaceholder7(" Gender ");
              setGender(text);
            }}
          />
          ...
          <TouchableOpacity
            style={styles.bdayandgenderinputstyle}
            onPress={() => {
              showMode("date"), Setminiplaceholder6("BirthDate");
            }}>
        ...
        <View style={styles.container3}>
          <TextInput
            ...
            placeholder="Age"
            onChangeText={(text) => {
              !text ? Setminiplaceholder8("") : Setminiplaceholder8(" Age ");
              setAge(text);
            }}
          />
