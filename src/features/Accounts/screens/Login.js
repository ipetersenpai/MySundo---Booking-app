      ...
      <View style={styles.pannel1}>
        ...
        <View style={styles.test}>
          ...
          <TextInput
            style={
              isFocused.entry1
                ? [styles.textinputstyle, { borderColor: "#438EFF" }]
              ...
              .then(function (response) {
                if (response.data[0].Message === "wrong password") {
                  ...
                  Alert.alert(
                    ...
                    "The credential you entered is not found in our system!",
                    [
                      {
                        text: "close",
                        onPress: () => console.log("alert closed"),
        ...
        <View style={{ top: "-2%", flexDirection: "row" }}>
          <Text style={styles.fontstyle4}>Forgot the password?</Text>
        ...
        <View style={styles.signuphere_nav}>
          <Text style={styles.fontstyle4}>Don’t have an account yet?</Text>
