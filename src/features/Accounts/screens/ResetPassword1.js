...
import { styles } from "../components/ResetPassword1Styles";
    ...
    <View style={styles.container}>
      ...
      <View style={styles.pannel1}>
        ...
        <Text style={styles.fontstyle2}>
          Enter your registered email address so we can send you a 4 digit code
        ...
        <TextInput
          style={
            isFocused.entry1
              ? [styles.textfield, { borderColor: "#438EFF" }]
              : styles.textfield
          }
          value={verfiedemail}
